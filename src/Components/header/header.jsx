  ...
  return (
    <>
      <div className="container-header-main D-f d-f-a">
        <header className={`D-f ${scrolled ? 'scrolled' : ''}`}>
          ...
          <nav className={`navbar  ${toggleClassCheck}`} >
            <ul>
              ...
              <li><a href="" className="underline-effect"><span>Services</span> <i className="fa-solid fa-chevron-down"></i></a>
                <ul>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1300 290"><path fill="#171717" fillOpacity="1" d="M0,224L40,224C80,224,160,224,240,213.3C320,203,400,181,480,165.3C560,149,640,139,720,149.3C800,160,880,192,960,192C1040,192,1120,160,1200,144C1280,128,1360,128,1400,128L1440,128L1440,320L1400,320C1360,320,1280,320,1200,320C1120,320,1040,320,960,320C880,320,800,320,720,320C640,320,560,320,480,320C400,320,320,320,240,320C160,320,80,320,40,320L0,320Z"></path></svg>
      </div>
